...
|---|---|---|---|
| v3.1 / build 31 | 2026-08-22 | <ul><li><strong>Change:</strong> Storage figures moved beside each button.</li></ul> | [Full record](#change-28) |
| v3.0 / build 30 | 2026-08-22 | <ul><li><strong>Change:</strong> Storage figures next to each reset action.</li></ul> | [Full record](#change-29) |
| v2.9 / build 29 | 2026-08-22 | <ul><li><strong>Change:</strong> Bordered reset rows matching the folder-card style.</li></ul> | [Full record](#change-30) |
| v2.8 / build 28 | 2026-08-22 | <ul><li><strong>Change:</strong> Simplified reset rows and corrected model-removal placement.</li></ul> | [Full record](#change-31) |
| v2.7 / build 27 | 2026-08-22 | <ul><li><strong>Change:</strong> Reset controls integrated into their owning sections.</li></ul> | [Full record](#change-32) |
| v2.6 / build 26 | 2026-08-22 | <ul><li><strong>Change:</strong> On-demand model removal, search-index reset, and status check.</li></ul> | [Full record](#change-33) |
| v2.5 / build 25 | 2026-08-21 | <ul><li><strong>Change:</strong> Complete folder hierarchy and precise folder-scoped results.</li></ul> | [Full record](#change-34) |
| v2.4 / build 24 | 2026-08-21 | <ul><li><strong>Change:</strong> Reliable type-only listings and idle command pulse.</li></ul> | [Full record](#change-35) |
| v2.3 / build 23 | 2026-08-21 | <ul><li><strong>Change:</strong> Folder-aware retrieval and coordinated interface motion.</li></ul> | [Full record](#change-36) |
| v2.2 / build 22 | 2026-08-21 | <ul><li><strong>Change:</strong> Evidence-backed result cards and honest visual-search limits.</li></ul> | [Full record](#change-37) |
| v2.1 / build 21 | 2026-08-21 | <ul><li><strong>Change:</strong> Bounded vector search, visible button hover states, and clarified semantic-image limits.</li></ul> | [Full record](#change-38) |
| v2.0 / build 20 | 2026-08-21 | <ul><li><strong>Change:</strong> Selectable voice interactions, finalized speech, and conversational follow-ups.</li></ul> | [Full record](#change-39) |
| v1.9 / build 19 | 2026-08-21 | <ul><li><strong>Change:</strong> One light visual family across every screen.</li></ul> | [Full record](#change-40) |
| v1.8 / build 18 | 2026-08-21 | <ul><li><strong>Change:</strong> Light command interface with acquired-file modules.</li></ul> | [Full record](#change-41) |
| v1.7 / build 17 | 2026-08-21 | <ul><li><strong>Change:</strong> Current command presentation with complete conversation History.</li></ul> | [Full record](#change-42) |
| Maintenance | 2026-08-21 | <ul><li><strong>Change:</strong> Added selectable voice input (click-to-speak or hold-to-talk) with a 120-second maximum-capture safeguard so the microphone can never stay open unattended.</li></ul> | [Full record](#change-91) |
| v1.6 / build 16 | 2026-08-20 | <ul><li><strong>Change:</strong> Spoken words appear and send, and the routing marker stays hidden.</li></ul> | [Full record](#change-43) |
| v1.5 / build 15 | 2026-08-20 | <ul><li><strong>Change:</strong> Recordings end on a pause and send what was said.</li></ul> | [Full record](#change-44) |
| v1.4 / build 14 | 2026-08-20 | <ul><li><strong>Change:</strong> Live waveform and on-screen speech, with no audio written to disk.</li></ul> | [Full record](#change-45) |
| v1.3 / build 13 | 2026-08-20 | <ul><li><strong>Change:</strong> The assistant stopped repeating its own result sentence.</li></ul> | [Full record](#change-46) |
| v1.2 / build 12 | 2026-08-20 | <ul><li><strong>Change:</strong> Vendored network code removed, with correctness fixes and automated tests.</li></ul> | [Full record](#change-47) |
| v1.1 / build 11 | 2026-08-20 | <ul><li><strong>Change:</strong> Simpler indexing controls and a clean shutdown on quit.</li></ul> | [Full record](#change-48) |
| v1.0 / build 10 | 2026-08-20 | <ul><li><strong>Change:</strong> Continuous folder monitoring, pausable indexing, and 30-day activity.</li></ul> | [Full record](#change-49) |
| v0.9 / build 9 | 2026-08-20 | <ul><li><strong>Change:</strong> Hard file-type filters, prompt safety, and tightened entitlements.</li></ul> | [Full record](#change-50) |
| v0.8 / build 8 | 2026-08-20 | <ul><li><strong>Change:</strong> Settings reordered, conversation text styled, and the README rewritten.</li></ul> | [Full record](#change-51) |
| v0.7 / build 7 | 2026-08-20 | <ul><li><strong>Change:</strong> Answers stopped repeating details already shown in the cards.</li></ul> | [Full record](#change-52) |
| v0.6 / build 6 | 2026-08-20 | <ul><li><strong>Change:</strong> Plain-language model readiness and result cards that survive relaunch.</li></ul> | [Full record](#change-53) |
| v0.5 / build 5 | 2026-08-20 | <ul><li><strong>Change:</strong> Message timestamps, Clear Conversation, and shorter result cards.</li></ul> | [Full record](#change-54) |
| v0.4 / build 4 | 2026-08-20 | <ul><li><strong>Change:</strong> Settings reorganized around status, folder access, and privacy.</li></ul> | [Full record](#change-55) |
| v0.3 / build 3 | 2026-08-20 | <ul><li><strong>Change:</strong> Local routing between chat, clarification, and file search.</li></ul> | [Full record](#change-56) |
| v0.2 / build 2 | 2026-08-20 | <ul><li><strong>Change:</strong> Focused interface with crash-safe indexing and folder revocation.</li></ul> | [Full record](#change-57) |
| v0.1 / build 1 | 2026-08-20 | <ul><li><strong>Change:</strong> First sandboxed assistant with local indexing, retrieval, and voice.</li></ul> | [Full record](#change-58) |
| Maintenance | 2026-08-20 | <ul><li><strong>Change:</strong> Committed v1.2–v1.6 extraction, search, voice, readiness, offline-boundary, and regression work.</li></ul> | [Full record](#change-99) |
| Maintenance | 2026-08-16 | <ul><li><strong>Change:</strong> Released v1.1 source with continuous native folder monitoring, pausable progress, and visible background indexing.</li></ul> | [Full record](#change-108) |
| Maintenance | 2026-08-15 | <ul><li><strong>Change:</strong> Imported the native offline assistant and its preserved source history, guardrails, target/configuration, tooling, indexing, private retrieval/storage, UI.</li></ul> | [Full record](#change-109) |
...
`0406220`, `3cd4429`, `cd137a4`, `ab335db`, `a456632`, `971ddc9`, `b14cdc4`, `d4d1921`, `7bb804e`, `c81f907`, `b11d6f2`, `079be3b`
