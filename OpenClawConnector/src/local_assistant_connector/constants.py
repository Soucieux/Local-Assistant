...
GROUP_AND_OTHER_ACCESS_MASK = 0o077
GROUP_AND_OTHER_WRITE_MASK = 0o022
...
WORKFLOW_NODE_VALIDATE = "validate"
WORKFLOW_NODE_REMINDER = "reminder"
WORKFLOW_NODE_AGENT = "agent"
...
SSH_HOST_KEY_INPUT_FIELD_COUNT = 2
SSH_HOST_MAXIMUM_LENGTH = 253
SSH_HOST_PATTERN = r"[A-Za-z0-9._:-]+"
SSH_OPTION_PREFIX = "-"
SSH_USER_PATTERN = r"[a-z_][a-z0-9_-]{0,31}"
SSH_PORT_MINIMUM = 1
