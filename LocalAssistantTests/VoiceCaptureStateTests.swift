...
internal struct VoiceCaptureStateTests {
    ...
    internal func joinsTranscriptParts() {
    ...
    internal func omitsSeparatorForSinglePart() {
    ...
    internal func ignoresOlderLoudAudio() {
    ...
    internal func reportsNoSilenceWithoutLevels() {
    ...
    internal func preparingStateIsEmpty() {
