...
struct SearchTextEscapingTests {
    ...
    func escapesTheEscapeCharacterFirst() {
    ...
    func yieldsNoTokensForBlankText() {
    ...
    func buildsConjunctiveFTSQuery() {
    ...
    func producesEmptyQueryForBlankText() {
